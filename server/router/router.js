...
module.exports = function(app) {
	...
	app.post('/api/auth/signup', [verifySignUp.checkDuplicateEmail,	verifySignUp.checkErrorEmail, verifySignUp.checkPassword, verifySignUp.checkRolesExisted], usercontroller.signup);
